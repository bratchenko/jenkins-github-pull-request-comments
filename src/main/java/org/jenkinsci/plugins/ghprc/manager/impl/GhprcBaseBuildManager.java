 ...
 */
public abstract class GhprcBaseBuildManager implements GhprcBuildManager {

    public GhprcBaseBuildManager(AbstractBuild<?, ?> build) {
        this.build = build;
        this.jobConfiguration = buildDefaultConfiguration();
    }

    public GhprcBaseBuildManager(AbstractBuild<?, ?> build, JobConfiguration jobConfiguration) {
        this.build = build;
    ...
    protected static final Logger LOGGER = Logger.getLogger(GhprcBaseBuildManager.class.getName());

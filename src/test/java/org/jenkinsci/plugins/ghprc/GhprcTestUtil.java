...
public class GhprcTestUtil {

    public static final int INITIAL_RATE_LIMIT = 5000;
    public static final String GHPRC_PLUGIN_NAME = "ghprc";
    ...
    private static String setUpCredentials() throws Exception {
        String credentialsId = Ghprc.createCredentials(apiUrl, "accessToken");
    ...
    public static void setupGhprcTriggerDescriptor(Map<String, Object> config) throws Exception {
        setupReq();
        if (config == null) {
        ...
        GhprcTrigger.getDscp().configure(req, jsonObject);
    ...
    public static GhprcTrigger getTrigger(Map<String, Object> values) throws Exception {
        setupReq();
        if (values == null) {
        ...
        GhprcTrigger trigger = req.bindJSON(GhprcTrigger.class, defaults);
    ...
    public static void triggerRunAndWait(int numOfTriggers, GhprcTrigger trigger, AbstractProject<?, ?> project) throws InterruptedException {
